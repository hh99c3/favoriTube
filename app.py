...
def mylist_post():
    ...
    try:
        ...
        beforeTitle_receive = request.form['beforeTitle_give']
        title_receive = request.form['title_give']
        comment_receive = request.form['comment_give']
        db.mylist.update_one({'title': beforeTitle_receive}, {'$set': {'title': title_receive }},)
        db.mylist.update_one({'title': title_receive }, {'$set': {'comment': comment_receive}}, )
